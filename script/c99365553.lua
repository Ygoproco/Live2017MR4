...
function c99365553.chkfilter(c,ft,sg,rg)
	local res
	if sg:GetCount()<2 then
		sg:AddCard(c)
		res=rg:IsExists(c99365553.chkfilter,1,sg,ft,sg,rg)
		sg:RemoveCard(c)
	else
		res=sg:FilterCount(c99365553.mzfilter,nil)+ft>0 and sg:IsExists(c99365553.atchk1,1,nil,sg)
	end
	return res
end
...
function c99365553.spcon1(e,c)
	...
	return ft>-2 and rg1:GetCount()>0 and rg2:GetCount()>0 and rg:IsExists(c99365553.chkfilter,1,nil,ft,Group.CreateGroup(),rg)
end
function c99365553.spop1(e,tp,eg,ep,ev,re,r,rp,c)
	...
	while g:GetCount()<2 do
		...
		local tc=rg:Filter(c99365553.chkfilter,g,ft,g,rg):SelectUnselect(g,tp)
